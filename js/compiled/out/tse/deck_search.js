...
tse.deck_search.deck_label = (function tse$deck_search$deck_label(p__98736,lang){
var map__98737 = p__98736;
var map__98737__$1 = cljs.core.__destructure_map.call(null,map__98737);
var name = cljs.core.get.call(null,map__98737__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
tse.deck_search.deck__GT_autocomplete_item = (function tse$deck_search$deck__GT_autocomplete_item(lang,p__98738){
var vec__98739 = p__98738;
var k = cljs.core.nth.call(null,vec__98739,(0),null);
var m = cljs.core.nth.call(null,vec__98739,(1),null);
...
tse.deck_search.view = (function tse$deck_search$view(p__98743){
var map__98744 = p__98743;
var map__98744__$1 = cljs.core.__destructure_map.call(null,map__98744);
var ctx = map__98744__$1;
var sub = cljs.core.get.call(null,map__98744__$1,new cljs.core.Keyword(null,"sub","sub",-2093760025));
var emit = cljs.core.get.call(null,map__98744__$1,new cljs.core.Keyword(null,"emit","emit",-1327179018));
...
}),(function (p1__98742_SHARP_){
return emit.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("deck","set-active","deck/set-active",256366800),cljs.core.get.call(null,p1__98742_SHARP_,new cljs.core.Keyword(null,"value","value",305978217))], null));
}),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"form","form",-1624062471),"(carbon.macros/lens\n {:label (deck-label @(sub [:deck/active]) @lang),\n  :value @(sub [:deck/active-id])}\n (fn* [p1__98742#] (emit [:deck/set-active (get p1__98742# :value)])))\n"], null));
...
//# sourceMappingURL=deck_search.js.map?rel=1767875391469
