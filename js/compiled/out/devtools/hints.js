...
var temp__5816__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5816__auto__)){
var val = temp__5816__auto__;
return val;
} else {
...
var map__104560 = top_item;
var map__104560__$1 = cljs.core.__destructure_map.call(null,map__104560);
var file = cljs.core.get.call(null,map__104560__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__104560__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__104560__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e104559){var _e = e104559;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5816__auto___104561 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5816__auto___104561)){
var seen_errors_104562 = temp__5816__auto___104561;
if(cljs.core.truth_(seen_errors_104562.has(self))){
} else {
seen_errors_104562.add(self);

var temp__5818__auto___104563 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5818__auto___104563)){
var sense_104564 = temp__5818__auto___104563;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_104564)].join(''));
} else {
}
}
} else {
...
var temp__5818__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5818__auto__)){
var sense = temp__5818__auto__;
...
//# sourceMappingURL=hints.js.map?rel=1767875395052
