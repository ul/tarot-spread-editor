...
var map__38549 = top_item;
var map__38549__$1 = cljs.core.__destructure_map.call(null,map__38549);
var file = cljs.core.get.call(null,map__38549__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38549__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38549__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e38548){var _e = e38548;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5816__auto___38550 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5816__auto___38550)){
var seen_errors_38551 = temp__5816__auto___38550;
if(cljs.core.truth_(seen_errors_38551.has(self))){
} else {
seen_errors_38551.add(self);

var temp__5818__auto___38552 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5818__auto___38552)){
var sense_38553 = temp__5818__auto___38552;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_38553)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1710474318770
