...
var o37602 = temp__5816__auto__;
var temp__5816__auto____$1 = (o37602["core"]);
if(cljs.core.truth_(temp__5816__auto____$1)){
var o37603 = temp__5816__auto____$1;
return (o37603["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36960__auto__ = f;
return (o__36960__auto__["toString"]).call(o__36960__auto__);
} else {
return "";
}
}catch (e37604){var _ = e37604;
return "";
}});
...
try{var o__36960__auto___37606 = t;
(o__36960__auto___37606["cljs$lang$ctorPrWriter"]).call(o__36960__auto___37606,t,writer);
}catch (e37605){var __37607 = e37605;
}
...
var char_code = (function (){var o__36960__auto__ = (new String(char$));
return (o__36960__auto__["charCodeAt"]).call(o__36960__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36960__auto__ = String;
return (o__36960__auto__["fromCharCode"]).call(o__36960__auto__,subscript_code);
});
/**
...
var o__36960__auto__ = String;
return (o__36960__auto__["fromCharCode"]).call(o__36960__auto__,superscript_code);
});
/**
...
}catch (e37610){var _e__36967__auto__ = e37610;
return false;
}})())){
...
var vec__37611 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37611,(0),null);
...
var len__5769__auto___37620 = arguments.length;
var i__5770__auto___37621 = (0);
while(true){
if((i__5770__auto___37621 < len__5769__auto___37620)){
args__5775__auto__.push((arguments[i__5770__auto___37621]));

var G__37622 = (i__5770__auto___37621 + (1));
i__5770__auto___37621 = G__37622;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37616){
var vec__37617 = p__37616;
var ns_detector = cljs.core.nth.call(null,vec__37617,(0),null);
...
var G__37623 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37624 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37623;
remaining_tokens = G__37624;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37614){
var G__37615 = cljs.core.first.call(null,seq37614);
var seq37614__$1 = cljs.core.next.call(null,seq37614);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37615,seq37614__$1);
}));
...
var vec__37628 = cljs.core.split_with.call(null,(function (p1__37627_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37627_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37628,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37628,(1),null);
...
var vec__37634 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37634,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37634,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37637 = cljs.core.rest.call(null,remaining_tokens);
var G__37638 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37637;
name_tokens = G__37638;
continue;
} else {
...
var vec__37641 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37641,(0),null);
var arity = cljs.core.nth.call(null,vec__37641,(1),null);
var vec__37644 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37644,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37644,(1),null);
var vec__37647 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37647,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37647,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37647,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37647,(3),null);
...
var vec__37653 = result;
var munged_ns = cljs.core.nth.call(null,vec__37653,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37653,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37653,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37653,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37653,(4),null);
var arity = cljs.core.nth.call(null,vec__37653,(5),null);
...
if(cljs.core.truth_(temp__5816__auto__)){
var vec__37657 = temp__5816__auto__;
var munged_name = cljs.core.nth.call(null,vec__37657,(0),null);
var args = cljs.core.nth.call(null,vec__37657,(1),null);
var vec__37660 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37660,(0),null);
var name = cljs.core.nth.call(null,vec__37660,(1),null);
...
var G__37663 = (arity + (1));
var G__37664 = (function (){var temp__5816__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5816__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37665){
var vec__37666 = p__37665;
var arity = cljs.core.nth.call(null,vec__37666,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37666,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__37669_SHARP_){
return cljs.core.get.call(null,arities,p1__37669_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__37670_SHARP_){
return cljs.core.drop.call(null,(2),p1__37670_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___37677 = arguments.length;
var i__5770__auto___37678 = (0);
while(true){
if((i__5770__auto___37678 < len__5769__auto___37677)){
args__5775__auto__.push((arguments[i__5770__auto___37678]));

var G__37679 = (i__5770__auto___37678 + (1));
i__5770__auto___37678 = G__37679;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37673){
var vec__37674 = p__37673;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37674,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37671){
var G__37672 = cljs.core.first.call(null,seq37671);
var seq37671__$1 = cljs.core.next.call(null,seq37671);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37672,seq37671__$1);
}));
...
var G__37680 = arg;
var G__37680__$1 = (((G__37680 instanceof cljs.core.Keyword))?G__37680.fqn:null);
switch (G__37680__$1) {
...
var map__37682 = options;
var map__37682__$1 = cljs.core.__destructure_map.call(null,map__37682);
var include_ns_QMARK_ = cljs.core.get.call(null,map__37682__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37682__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37682__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37682__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37683 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37683,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37683,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37683,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37683,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37683,(4),null);
var arity = cljs.core.nth.call(null,vec__37683,(5),null);
...
var o__36960__auto__ = f;
return (o__36960__auto__["getBasis"]).call(o__36960__auto__);
});
/**
...
}catch (e37686){var _e__36967__auto__ = e37686;
...
var G__37687 = (obj[cljs.core.first.call(null,path)]);
var G__37688 = cljs.core.rest.call(null,path);
obj = G__37687;
path = G__37688;
continue;
} else {
...
var _STAR_ = (function (accum,p__37689){
var vec__37690 = p__37689;
var bit = cljs.core.nth.call(null,vec__37690,(0),null);
var protocol = cljs.core.nth.call(null,vec__37690,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37693){
...
var selector = cljs.core.nth.call(null,vec__37694,(2),null);
...
var post_process = (function (p__37698){
var vec__37699 = p__37698;
var munged_name = cljs.core.nth.call(null,vec__37699,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37699,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__37697_SHARP_){
return (obj[cljs.core.first.call(null,p1__37697_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1710474318208
