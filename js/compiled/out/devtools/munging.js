...
var temp__5816__auto__ = (function (){var temp__5816__auto__ = (devtools.munging.get_global_scope.call(null)["cljs"]);
if(cljs.core.truth_(temp__5816__auto__)){
var o103701 = temp__5816__auto__;
var temp__5816__auto____$1 = (o103701["core"]);
if(cljs.core.truth_(temp__5816__auto____$1)){
var o103702 = temp__5816__auto____$1;
return (o103702["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5816__auto__)){
var js_reserved_fn = temp__5816__auto__;
...
var o__30608__auto__ = f;
return (o__30608__auto__["toString"]).call(o__30608__auto__);
} else {
return "";
}
}catch (e103703){var _ = e103703;
return "";
}});
...
try{var o__30608__auto___103705 = t;
(o__30608__auto___103705["cljs$lang$ctorPrWriter"]).call(o__30608__auto___103705,t,writer);
}catch (e103704){var __103706 = e103704;
}
...
var char_code = (function (){var o__30608__auto__ = (new String(char$));
return (o__30608__auto__["charCodeAt"]).call(o__30608__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30608__auto__ = String;
return (o__30608__auto__["fromCharCode"]).call(o__30608__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__103707 = num_code;
switch (G__103707) {
case (1):
return (185);
...
var o__30608__auto__ = String;
return (o__30608__auto__["fromCharCode"]).call(o__30608__auto__,superscript_code);
});
/**
...
var temp__5816__auto__ = cljs.core.second.call(null,cljs.core.re_find.call(null,/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5816__auto__)){
var meat = temp__5816__auto__;
var temp__5816__auto____$1 = cljs.core.re_find.call(null,/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5816__auto____$1)){
var match = temp__5816__auto____$1;
...
}catch (e103709){var _e__30615__auto__ = e103709;
return false;
}})())){
...
var vec__103710 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__103710,(0),null);
...
var or__5045__auto__ = (function (){var temp__5816__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5816__auto__)){
...
var temp__5820__auto__ = devtools.munging.goog$module$goog$object.getValueByKeys.call(null,devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5820__auto__ == null)){
return null;
} else {
var ns_obj = temp__5820__auto__;
...
var len__5769__auto___103719 = arguments.length;
var i__5770__auto___103720 = (0);
while(true){
if((i__5770__auto___103720 < len__5769__auto___103719)){
args__5775__auto__.push((arguments[i__5770__auto___103720]));

var G__103721 = (i__5770__auto___103720 + (1));
i__5770__auto___103720 = G__103721;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__103715){
var vec__103716 = p__103715;
var ns_detector = cljs.core.nth.call(null,vec__103716,(0),null);
...
var G__103722 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__103723 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__103722;
remaining_tokens = G__103723;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq103713){
var G__103714 = cljs.core.first.call(null,seq103713);
var seq103713__$1 = cljs.core.next.call(null,seq103713);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__103714,seq103713__$1);
}));
...
var vec__103727 = cljs.core.split_with.call(null,(function (p1__103726_SHARP_){
return cljs.core.not_EQ_.call(null,p1__103726_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__103727,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__103727,(1),null);
...
var vec__103733 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__103733,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__103733,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__103736 = cljs.core.rest.call(null,remaining_tokens);
var G__103737 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__103736;
name_tokens = G__103737;
continue;
} else {
...
var G__103739 = arguments.length;
switch (G__103739) {
case 1:
...
var vec__103740 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__103740,(0),null);
var arity = cljs.core.nth.call(null,vec__103740,(1),null);
var vec__103743 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__103743,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__103743,(1),null);
var vec__103746 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__103746,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__103746,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__103746,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__103746,(3),null);
...
var G__103751 = arguments.length;
switch (G__103751) {
case 1:
...
var vec__103752 = result;
var munged_ns = cljs.core.nth.call(null,vec__103752,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__103752,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__103752,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__103752,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__103752,(4),null);
var arity = cljs.core.nth.call(null,vec__103752,(5),null);
...
var temp__5816__auto__ = devtools.munging.parse_fn_source.call(null,fn_source);
if(cljs.core.truth_(temp__5816__auto__)){
var vec__103756 = temp__5816__auto__;
var munged_name = cljs.core.nth.call(null,vec__103756,(0),null);
var args = cljs.core.nth.call(null,vec__103756,(1),null);
var vec__103759 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__103759,(0),null);
var name = cljs.core.nth.call(null,vec__103759,(1),null);
...
var temp__5816__auto__ = cljs.core.get.call(null,state,prefix);
if(cljs.core.truth_(temp__5816__auto__)){
var subscript = temp__5816__auto__;
...
var G__103762 = (arity + (1));
var G__103763 = (function (){var temp__5816__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5816__auto__)){
var arity_fn = temp__5816__auto__;
...
var temp__5816__auto__ = devtools.munging.get_fn_variadic_arity.call(null,f);
if(cljs.core.truth_(temp__5816__auto__)){
var variadic_arity = temp__5816__auto__;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__103764){
var vec__103765 = p__103764;
var arity = cljs.core.nth.call(null,vec__103765,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__103765,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__103768_SHARP_){
return cljs.core.get.call(null,arities,p1__103768_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__103769_SHARP_){
return cljs.core.drop.call(null,(2),p1__103769_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___103776 = arguments.length;
var i__5770__auto___103777 = (0);
while(true){
if((i__5770__auto___103777 < len__5769__auto___103776)){
args__5775__auto__.push((arguments[i__5770__auto___103777]));

var G__103778 = (i__5770__auto___103777 + (1));
i__5770__auto___103777 = G__103778;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__103772){
var vec__103773 = p__103772;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__103773,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq103770){
var G__103771 = cljs.core.first.call(null,seq103770);
var seq103770__$1 = cljs.core.next.call(null,seq103770);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__103771,seq103770__$1);
}));
...
var map__103781 = options;
var map__103781__$1 = cljs.core.__destructure_map.call(null,map__103781);
var include_ns_QMARK_ = cljs.core.get.call(null,map__103781__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__103781__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__103781__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__103781__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__103782 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__103782,(0),null);
var fn_name = cljs.core.nth.call(null,vec__103782,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__103782,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__103782,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__103782,(4),null);
var arity = cljs.core.nth.call(null,vec__103782,(5),null);
...
var o__30608__auto__ = f;
return (o__30608__auto__["getBasis"]).call(o__30608__auto__);
});
/**
...
}catch (e103785){var _e__30615__auto__ = e103785;
...
var G__103786 = (obj[cljs.core.first.call(null,path)]);
var G__103787 = cljs.core.rest.call(null,path);
obj = G__103786;
path = G__103787;
continue;
} else {
...
var temp__5816__auto__ = cljs.core.re_matches.call(null,/(.*)\$$/,key);
if(cljs.core.truth_(temp__5816__auto__)){
var m = temp__5816__auto__;
...
var _STAR_ = (function (accum,p__103788){
var vec__103789 = p__103788;
var bit = cljs.core.nth.call(null,vec__103789,(0),null);
var protocol = cljs.core.nth.call(null,vec__103789,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__103792){
var vec__103793 = p__103792;
var ns = cljs.core.nth.call(null,vec__103793,(0),null);
var name = cljs.core.nth.call(null,vec__103793,(1),null);
var selector = cljs.core.nth.call(null,vec__103793,(2),null);
...
var post_process = (function (p__103797){
var vec__103798 = p__103797;
var munged_name = cljs.core.nth.call(null,vec__103798,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__103798,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__103796_SHARP_){
return (obj[cljs.core.first.call(null,p1__103796_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1767875394511
