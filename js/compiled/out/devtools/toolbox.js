...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox104404 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox104404 = (function (obj,header,style,tag,meta104405){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
this.meta104405 = meta104405;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(devtools.toolbox.t_devtools$toolbox104404.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_104406,meta104405__$1){
var self__ = this;
var _104406__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox104404(self__.obj,self__.header,self__.style,self__.tag,meta104405__$1));
}));

(devtools.toolbox.t_devtools$toolbox104404.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_104406){
var self__ = this;
var _104406__$1 = this;
return self__.meta104405;
}));

(devtools.toolbox.t_devtools$toolbox104404.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox104404.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox104404.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox104404.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox104404.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta104405","meta104405",580447881,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox104404.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox104404.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox104404");

(devtools.toolbox.t_devtools$toolbox104404.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"devtools.toolbox/t_devtools$toolbox104404");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox104404.
 */
devtools.toolbox.__GT_t_devtools$toolbox104404 = (function devtools$toolbox$__GT_t_devtools$toolbox104404(obj__$1,header__$1,style__$1,tag__$1,meta104405){
return (new devtools.toolbox.t_devtools$toolbox104404(obj__$1,header__$1,style__$1,tag__$1,meta104405));
});

}

return (new devtools.toolbox.t_devtools$toolbox104404(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
...
//# sourceMappingURL=toolbox.js.map?rel=1767875394959
