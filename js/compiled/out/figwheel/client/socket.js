...
}catch (e50988){if((e50988 instanceof Error)){
var e = e50988;
return null;
} else {
throw e50988;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__50989){
...
var opts = map__50990__$1;
var retry_count = cljs.core.get.call(null,map__50990__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__50990__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__50990__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__50990__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__5557__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__5557__auto__)){
var WebSocket = temp__5557__auto__;
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__5559__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__5559__auto__)){
var msg = temp__5559__auto__;
...
});})(url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__5557__auto__,map__50990,map__50990__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1537946273153
