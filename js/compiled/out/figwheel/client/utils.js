...
return (new CustomEvent(event_name,(function (){var obj49401 = {"detail":data};
return obj49401;
})()));
} else {
...
var f = (function (){var pred__49408 = cljs.core._EQ_;
var expr__49409 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49408.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49409))){
return ((function (pred__49408,expr__49409){
return (function (p1__49402_SHARP_){
return console.warn(p1__49402_SHARP_);
});
;})(pred__49408,expr__49409))
} else {
if(cljs.core.truth_(pred__49408.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49409))){
return ((function (pred__49408,expr__49409){
return (function (p1__49403_SHARP_){
return console.debug(p1__49403_SHARP_);
});
;})(pred__49408,expr__49409))
} else {
if(cljs.core.truth_(pred__49408.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49409))){
return ((function (pred__49408,expr__49409){
return (function (p1__49404_SHARP_){
return console.error(p1__49404_SHARP_);
});
;})(pred__49408,expr__49409))
} else {
return ((function (pred__49408,expr__49409){
return (function (p1__49405_SHARP_){
return console.log(p1__49405_SHARP_);
});
;})(pred__49408,expr__49409))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49412){
...
var eval_fn = cljs.core.get.call(null,map__49413__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49415_SHARP_);
});})(new_def))
);
...
return (function (p__49416){
var vec__49417 = p__49416;
var ky = cljs.core.nth.call(null,vec__49417,(0),null);
var v = cljs.core.nth.call(null,vec__49417,(1),null);
...
}catch (e49422){if((e49422 instanceof Error)){
var e = e49422;
return not_found;
} else {
throw e49422;
...
//# sourceMappingURL=utils.js.map?rel=1537946268583
