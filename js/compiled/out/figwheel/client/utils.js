...
return (new CustomEvent(event_name,(function (){var obj106479 = ({"detail":data});
return obj106479;
})()));
} else {
...
var f = (function (){var pred__106486 = cljs.core._EQ_;
var expr__106487 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__106486.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__106487))){
return (function (p1__106480_SHARP_){
return console.warn(p1__106480_SHARP_);
});
} else {
if(cljs.core.truth_(pred__106486.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__106487))){
return (function (p1__106481_SHARP_){
return console.debug(p1__106481_SHARP_);
});
} else {
if(cljs.core.truth_(pred__106486.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__106487))){
return (function (p1__106482_SHARP_){
return console.error(p1__106482_SHARP_);
});
} else {
return (function (p1__106483_SHARP_){
return console.log(p1__106483_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__106490){
var map__106491 = p__106490;
var map__106491__$1 = cljs.core.__destructure_map.call(null,map__106491);
var opts = map__106491__$1;
var eval_fn = cljs.core.get.call(null,map__106491__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__106492_SHARP_){
return new_def.callback(p1__106492_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__106493){
var vec__106494 = p__106493;
var ky = cljs.core.nth.call(null,vec__106494,(0),null);
var v = cljs.core.nth.call(null,vec__106494,(1),null);
...
var G__106498 = arguments.length;
switch (G__106498) {
case 2:
...
}catch (e106499){if((e106499 instanceof Error)){
var e = e106499;
return not_found;
} else {
throw e106499;
...
//# sourceMappingURL=utils.js.map?rel=1767875395529
