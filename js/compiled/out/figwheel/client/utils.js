...
return (new CustomEvent(event_name,(function (){var obj41827 = ({"detail":data});
return obj41827;
})()));
} else {
...
var f = (function (){var pred__41834 = cljs.core._EQ_;
var expr__41835 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41834.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41835))){
return (function (p1__41828_SHARP_){
return console.warn(p1__41828_SHARP_);
});
} else {
if(cljs.core.truth_(pred__41834.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41835))){
return (function (p1__41829_SHARP_){
return console.debug(p1__41829_SHARP_);
});
} else {
if(cljs.core.truth_(pred__41834.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41835))){
return (function (p1__41830_SHARP_){
return console.error(p1__41830_SHARP_);
});
} else {
return (function (p1__41831_SHARP_){
return console.log(p1__41831_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41838){
var map__41839 = p__41838;
var map__41839__$1 = cljs.core.__destructure_map.call(null,map__41839);
var opts = map__41839__$1;
var eval_fn = cljs.core.get.call(null,map__41839__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__41840_SHARP_){
return new_def.callback(p1__41840_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__41841){
var vec__41842 = p__41841;
var ky = cljs.core.nth.call(null,vec__41842,(0),null);
var v = cljs.core.nth.call(null,vec__41842,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1710474319413
