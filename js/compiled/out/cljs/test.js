...
var G__102557 = arguments.length;
switch (G__102557) {
case 0:
...
var G__102558 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__102558,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__102558;
}
}));
...
var len__5769__auto___102563 = arguments.length;
var i__5770__auto___102564 = (0);
while(true){
if((i__5770__auto___102564 < len__5769__auto___102563)){
args__5775__auto__.push((arguments[i__5770__auto___102564]));

var G__102565 = (i__5770__auto___102564 + (1));
i__5770__auto___102564 = G__102565;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq102560){
var G__102561 = cljs.core.first.call(null,seq102560);
var seq102560__$1 = cljs.core.next.call(null,seq102560);
var G__102562 = cljs.core.first.call(null,seq102560__$1);
var seq102560__$2 = cljs.core.next.call(null,seq102560__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__102561,G__102562,seq102560__$2);
}));
...
var map__102567 = m;
var map__102567__$1 = cljs.core.__destructure_map.call(null,map__102567);
var file = cljs.core.get.call(null,map__102567__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__102567__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__102567__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__102566_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__102566_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__5642__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__5045__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var temp__5818__auto___102568 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5818__auto___102568)){
var message_102569 = temp__5818__auto___102568;
cljs.core.println.call(null,message_102569);
} else {
}
...
var temp__5818__auto___102570 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5818__auto___102570)){
var message_102571 = temp__5818__auto___102570;
cljs.core.println.call(null,message_102571);
} else {
}
...
var output_dir__$1 = (function (){var G__102572 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__102572,"/"].join('');
} else {
return G__102572;
}
})();
...
var temp__5816__auto__ = new cljs.core.Keyword(null,"source-map","source-map",1706252311).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(temp__5816__auto__)){
var source_map = temp__5816__auto__;
var temp__5816__auto____$1 = cljs.core.get_in.call(null,source_map,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [filename,(line - (1))], null));
if(cljs.core.truth_(temp__5816__auto____$1)){
var columns = temp__5816__auto____$1;
return cljs.core.vec.call(null,cljs.core.map.call(null,cljs.core.first.call(null,(function (){var temp__5816__auto____$2 = cljs.core.get.call(null,columns,(column - (1)));
if(cljs.core.truth_(temp__5816__auto____$2)){
var mapping = temp__5816__auto____$2;
return mapping;
} else {
...
var temp__5816__auto__ = (function (){var and__5043__auto__ = typeof exception.stack === 'string';
if(and__5043__auto__){
var G__102573 = exception.stack;
var G__102573__$1 = (((G__102573 == null))?null:clojure.string.split_lines.call(null,G__102573));
var G__102573__$2 = (((G__102573__$1 == null))?null:cljs.core.get.call(null,G__102573__$1,depth));
if((G__102573__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__102573__$2);
}
} else {
...
if(cljs.core.truth_(temp__5816__auto__)){
var stack_element = temp__5816__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__102574 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__102574,(0),null);
var column = cljs.core.nth.call(null,vec__102574,(1),null);
var vec__102577 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__102577,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__102577,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__102577,(2),null);
...
var m__$1 = (function (){var G__102580 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__102580__$1 = (((G__102580 instanceof cljs.core.Keyword))?G__102580.fqn:null);
switch (G__102580__$1) {
case "fail":
...
while(true){
var temp__5818__auto__ = cljs.core.seq.call(null,fns);
if(temp__5818__auto__){
var xs__6376__auto__ = temp__5818__auto__;
var f = cljs.core.first.call(null,xs__6376__auto__);
var obj = f.call(null);
if(cljs.test.async_QMARK_.call(null,obj)){
return obj.call(null,(function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6376__auto__,temp__5818__auto__){
return (function (){
return cljs.test.run_block.call(null,cljs.core.rest.call(null,fns));
});})(fns,obj,f,xs__6376__auto__,temp__5818__auto__))
,null));
return ((function (fns,d,obj,f,xs__6376__auto__,temp__5818__auto__){
return (function (){
...
;})(fns,d,obj,f,xs__6376__auto__,temp__5818__auto__))
})());
} else {
var G__102584 = (function (){var G__102583 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__102583);
} else {
return G__102583;
}
})();
...
return cljs.core.vary_meta.call(null,G__102585,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e102586){var e = e102586;
var G__102587 = e;
var G__102587__$1 = (((G__102587 instanceof cljs.core.Keyword))?G__102587.fqn:null);
switch (G__102587__$1) {
...
var temp__5816__auto__ = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5816__auto__)){
var t = temp__5816__auto__;
...
var vec__102589 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__102589,(0),null);
var types = vec__102589;
...
return cljs.core.map.call(null,(function (p__102592){
var vec__102593 = p__102592;
var ns = cljs.core.nth.call(null,vec__102593,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__102593,(1),null);
return (function (){
...
var G__102596 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__102596__$1 = (((G__102596 instanceof cljs.core.Keyword))?G__102596.fqn:null);
switch (G__102596__$1) {
case "async":
...
var seq__102597 = cljs.core.seq.call(null,vars__$1);
var chunk__102598 = null;
var count__102599 = (0);
var i__102600 = (0);
while(true){
if((i__102600 < count__102599)){
var v = cljs.core._nth.call(null,chunk__102598,i__102600);
var temp__5818__auto___102602 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5818__auto___102602)){
var t_102603 = temp__5818__auto___102602;
each_fixture_fn.call(null,((function (seq__102597,chunk__102598,count__102599,i__102600,t_102603,temp__5818__auto___102602,v,each_fixture_fn,G__102596,G__102596__$1,env,once_fixtures,each_fixtures,vec__102593,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_102603)));
});})(seq__102597,chunk__102598,count__102599,i__102600,t_102603,temp__5818__auto___102602,v,each_fixture_fn,G__102596,G__102596__$1,env,once_fixtures,each_fixtures,vec__102593,ns,vars__$1))
);
} else {
}


var G__102604 = seq__102597;
var G__102605 = chunk__102598;
var G__102606 = count__102599;
var G__102607 = (i__102600 + (1));
seq__102597 = G__102604;
chunk__102598 = G__102605;
count__102599 = G__102606;
i__102600 = G__102607;
continue;
} else {
var temp__5818__auto__ = cljs.core.seq.call(null,seq__102597);
if(temp__5818__auto__){
var seq__102597__$1 = temp__5818__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__102597__$1)){
var c__5568__auto__ = cljs.core.chunk_first.call(null,seq__102597__$1);
var G__102608 = cljs.core.chunk_rest.call(null,seq__102597__$1);
var G__102609 = c__5568__auto__;
var G__102610 = cljs.core.count.call(null,c__5568__auto__);
var G__102611 = (0);
seq__102597 = G__102608;
chunk__102598 = G__102609;
count__102599 = G__102610;
i__102600 = G__102611;
continue;
} else {
var v = cljs.core.first.call(null,seq__102597__$1);
var temp__5818__auto___102612__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5818__auto___102612__$1)){
var t_102613 = temp__5818__auto___102612__$1;
each_fixture_fn.call(null,((function (seq__102597,chunk__102598,count__102599,i__102600,t_102613,temp__5818__auto___102612__$1,v,seq__102597__$1,temp__5818__auto__,each_fixture_fn,G__102596,G__102596__$1,env,once_fixtures,each_fixtures,vec__102593,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_102613)));
});})(seq__102597,chunk__102598,count__102599,i__102600,t_102613,temp__5818__auto___102612__$1,v,seq__102597__$1,temp__5818__auto__,each_fixture_fn,G__102596,G__102596__$1,env,once_fixtures,each_fixtures,vec__102593,ns,vars__$1))
);
} else {
}


var G__102614 = cljs.core.next.call(null,seq__102597__$1);
var G__102615 = null;
var G__102616 = (0);
var G__102617 = (0);
seq__102597 = G__102614;
chunk__102598 = G__102615;
count__102599 = G__102616;
i__102600 = G__102617;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__102596__$1)].join('')));
...
//# sourceMappingURL=test.js.map?rel=1767875393973
