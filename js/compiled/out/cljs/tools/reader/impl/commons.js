...
var G__46968 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46968;
continue;
} else {
return ch;
...
var vec__46969 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__46969,(0),null);
return (match === s);
});
...
var len__4531__auto___46974 = arguments.length;
var i__4532__auto___46975 = (0);
while(true){
if((i__4532__auto___46975 < len__4531__auto___46974)){
args__4534__auto__.push((arguments[i__4532__auto___46975]));

var G__46976 = (i__4532__auto___46975 + (1));
i__4532__auto___46975 = G__46976;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46972){
var G__46973 = cljs.core.first.call(null,seq46972);
var seq46972__$1 = cljs.core.next.call(null,seq46972);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46973,seq46972__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46977__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__46977 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46978__i = 0, G__46978__a = new Array(arguments.length -  1);
while (G__46978__i < G__46978__a.length) {G__46978__a[G__46978__i] = arguments[G__46978__i + 1]; ++G__46978__i;}
  _ = new cljs.core.IndexedSeq(G__46978__a,0,null);
} 
return G__46977__delegate.call(this,rdr,_);};
G__46977.cljs$lang$maxFixedArity = 1;
G__46977.cljs$lang$applyTo = (function (arglist__46979){
var rdr = cljs.core.first(arglist__46979);
var _ = cljs.core.rest(arglist__46979);
return G__46977__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1537946264519
