...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_98860 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_98860.call(null,reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_98861 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_98861.call(null,reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_98862 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_98862.call(null,reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_98863 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_98863.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_98864 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_98864.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_98865 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_98865.call(null,reader);
}
});
...
var self__ = this;
var reader__$1 = this;
var temp__5818__auto__ = cljs.tools.reader.reader_types.read_char.call(null,self__.rdr);
if(cljs.core.truth_(temp__5818__auto__)){
var ch = temp__5818__auto__;
...
var temp__5818__auto__ = new cljs.core.Keyword(null,"buffer","buffer",617295198).cljs$core$IFn$_invoke$arity$1(frames);
if(cljs.core.truth_(temp__5818__auto__)){
var buffer = temp__5818__auto__;
...
var G__98876 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
var G__98877 = s.append(c);
c = G__98876;
s = G__98877;
continue;
}
...
//# sourceMappingURL=reader_types.js.map?rel=1767875391590
