...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_102647 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_102647.call(null,this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_102648 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_102648.call(null,this$);
}
});
...
var pred__102650 = cljs.core._EQ_;
var expr__102651 = (this$["nodeType"]);
if(cljs.core.truth_(pred__102650.call(null,hickory.core.Attribute,expr__102651))){
...
var pred__102653 = cljs.core._EQ_;
var expr__102654 = (this$["nodeType"]);
if(cljs.core.truth_(pred__102653.call(null,hickory.core.Attribute,expr__102654))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__102653.call(null,hickory.core.Comment,expr__102654))){
...
if(cljs.core.truth_(pred__102653.call(null,hickory.core.Document,expr__102654))){
...
if(cljs.core.truth_(pred__102653.call(null,hickory.core.DocumentType,expr__102654))){
...
if(cljs.core.truth_(pred__102653.call(null,hickory.core.Element,expr__102654))){
...
if(cljs.core.truth_(pred__102653.call(null,hickory.core.Text,expr__102654))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__102654)].join('')));
}
}
}
}
...
var temp__5818__auto__ = cljs.core.second.call(null,(function (){var or__5045__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var doctype = temp__5818__auto__;
...
var temp__5818__auto___102656 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5818__auto___102656)){
var title_el_102657 = temp__5818__auto___102656;
if(cljs.core.empty_QMARK_.call(null,(title_el_102657["text"]))){
hickory.core.remove_el.call(null,title_el_102657);
} else {
}
} else {
}
...
//# sourceMappingURL=core.js.map?rel=1767875394016
