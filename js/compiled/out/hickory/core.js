...
var m__4244__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__4243__auto__)]);
if(!((m__4244__auto__ == null))){
return m__4244__auto__.call(null,this$);
} else {
var m__4244__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__4243__auto__ = (((this$ == null))?null:this$);
var m__4244__auto__ = (hickory.core.as_hickory[goog.typeOf(x__4243__auto__)]);
if(!((m__4244__auto__ == null))){
return m__4244__auto__.call(null,this$);
} else {
var m__4244__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__4244__auto____$1 == null))){
return m__4244__auto____$1.call(null,this$);
} else {
...
var pred__53706 = cljs.core._EQ_;
var expr__53707 = (this$["nodeType"]);
if(cljs.core.truth_(pred__53706.call(null,hickory.core.Attribute,expr__53707))){
...
var pred__53709 = cljs.core._EQ_;
var expr__53710 = (this$["nodeType"]);
if(cljs.core.truth_(pred__53709.call(null,hickory.core.Attribute,expr__53710))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__53709.call(null,hickory.core.Comment,expr__53710))){
...
if(cljs.core.truth_(pred__53709.call(null,hickory.core.Document,expr__53710))){
...
if(cljs.core.truth_(pred__53709.call(null,hickory.core.DocumentType,expr__53710))){
...
if(cljs.core.truth_(pred__53709.call(null,hickory.core.Element,expr__53710))){
...
if(cljs.core.truth_(pred__53709.call(null,hickory.core.Text,expr__53710))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__53710)].join('')));
}
}
}
}
...
var temp__5559__auto__ = cljs.core.second.call(null,(function (){var or__3949__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var doctype = temp__5559__auto__;
...
var temp__5559__auto___53712 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5559__auto___53712)){
var title_el_53713 = temp__5559__auto___53712;
if(cljs.core.empty_QMARK_.call(null,(title_el_53713["text"]))){
hickory.core.remove_el.call(null,title_el_53713);
} else {
}
} else {
}
...
var or__3949__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1537946282534
